  ...
  <div class="main_resize">
    ...
    <div class="content">
      <div class="content_bg">
        <div class="mainbar">
          <div class="article">
            <h2><span>Kritik & Saran</span></h2>
            <div class="clr"></div>
            <p>Posted by <a href="#">REZA EKA PRASETYO</a> <span>&nbsp;&bull;&nbsp;</span> H I M I F D A</p>
          ...
          <div class="article">
            <h2><span>Silahkan</span> Berkomentar</h2>
            <div class="clr"></div>
            <form action="komentar.php" method="post" id="leavereply">
              <ol>
                <li>
                  <label for="name">Nama (required)</label>
                  <input id="name" name="nama" class="text" />
                </li>
                <li>
                  <label for="email">Alamat E-mail (required)</label>
                  <input id="email" name="email" class="text" />
                </li>
                <li>
                  <label for="message">Pesan Anda</label>
                  <textarea id="message" name="komentar" rows="8" cols="50"></textarea>
                </li>
                <li>
